            ...
            <OverlapGroup12>
              <OverlapGroup6>
                <OverlapGroup>
                  ...
                  <Image src={image} />
                  <Group14034 className={group14034Props.className} />
                ...
                <OverlapGroup2>
                  ...
                  <Image src={image2} />
                  <Image1 src={image3} />
                  <Group14034 className={group140343Props.className} />
                  <Text109>{text111}</Text109>
                  <Scrollin>{liveLaw}</Scrollin>
                </OverlapGroup2>
                <OverlapGroup3>
                  <Rectangle69></Rectangle69>
                  <Image src={image4} />
                  <Rectangle71 src={rectangle71} />
                  <Group14034 className={group140344Props.className} />
                  <Text109>{text112}</Text109>
                  <Scrollin>{epw}</Scrollin>
                </OverlapGroup3>
                <OverlapGroup4>
                  <Rectangle69></Rectangle69>
                  <Image src={image5} />
                  <Image1 src={image6} />
                  <Group14034 className={group140345Props.className} />
